...
namespace Algorithms
{
    ...
    //numToStr("aaaaaaaaaaaaaa");
         ...
         public IEnumerable<T> UniqueInOrder<T>(IEnumerable<T> iter)
    {
    ...
    //UniqueInOrder([1, 2, 2, 3, 3]);  
        ...
        public int ips_between(string a, string b)
    {
    ...
    //ips_between("20.0.0.10","20.0.1.0");
        ...
        public Array createSpiral(int n)
    {
        int val = 1;
        int[,] arr = new int[n, n];
        int m = n;
